...
label you want to predict from this modality's subjective features.
"""
...
from Common.data_provider import SubjectiveDataProvider
...
def main():
    provider = SubjectiveDataProvider()
    exp = Experiment(
        name="subjective_ml",
        provider=provider,
